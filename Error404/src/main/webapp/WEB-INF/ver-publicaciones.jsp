      ...
      <div class="layout-page">
            ...
            <ul class="navbar-nav flex-row align-items-center ms-0">
              ...
              <li class="nav-item navbar-dropdown dropdown-user dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                  ...
                  <li>
                    <a class="dropdown-item" href="${pageContext.request.contextPath}/index.html">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl container-p-y">
            <!-- Main content area (similar to what you provided) -->
                        ...
                        <div class="card d-flex flex-column"  style="border: 1px solid #ddd; box-shadow: none; width: 100%; max-width: 250px;">
                          ...
                          <div class="card-body p-2 d-flex flex-column">
                            ...
                            <div class="d-flex flex-column gap-1 text-nowrap mt-auto mb-auto">
                              <a class="btn btn-label-info d-flex align-items-center" style="font-size: 0.75rem;" href="ver-publicaciones-detalles-usuario.html">
                                <span>Detalles</span><i class="bx bx-chevron-right lh-1 scaleX-n1-rtl"></i>
                              </a>
                              <button type="button" class="btn btn-label-primary d-flex align-items-center btn-inscripcion" data-event-id="1" user-type="usuario" post-type="publi" style="font-size: 0.75rem;">
                        ...
                        <div class="card d-flex flex-column" style="border: 1px solid #ddd; box-shadow: none; width: 100%; max-width: 250px;">
                          ...
                          <div class="card-body p-2 d-flex flex-column">
                            ...
                            <div class="d-flex flex-column gap-1 text-nowrap mt-auto">
                              ...
                              <button type="button" class="btn btn-label-primary d-flex align-items-center btn-inscripcion" data-event-id="2" user-type="usuario" post-type="publi" style="font-size: 0.75rem;">
                                <span>Inscripción</span><i class="bx bx-chevron-right lh-1 scaleX-n1-rtl"></i>
                              </button>
                            </div>
                          </div>
                        ...
                        <div class="card d-flex flex-column" style="border: 1px solid #ddd; box-shadow: none; width: 100%; max-width: 250px;">
                          ...
                          <div class="card-body p-2 d-flex flex-column">
                            ...
                            <div class="d-flex flex-column gap-1 text-nowrap mt-auto">
                              ...
                              <button type="button" class="btn btn-label-primary d-flex align-items-center btn-inscripcion" data-event-id="3" user-type="usuario" post-type="publi" style="font-size: 0.75rem;">
                                <span>Inscripción</span><i class="bx bx-chevron-right lh-1 scaleX-n1-rtl"></i>
                              </button>
                            </div>
                          </div>
                        ...
                        <div class="card d-flex flex-column" style="border: 1px solid #ddd; box-shadow: none; width: 100%; max-width: 250px;">
                          ...
                          <div class="card-body p-2 d-flex flex-column">
                            ...
                            <div class="d-flex flex-column gap-1 text-nowrap mt-auto">
                              ...
                              <button type="button" class="btn btn-label-primary d-flex align-items-center btn-inscripcion" data-event-id="4" user-type="usuario" post-type="publi" style="font-size: 0.75rem;">
                                <span>Inscripción</span><i class="bx bx-chevron-right lh-1 scaleX-n1-rtl"></i>
                              </button>
                            </div>
                          </div>
                        ...
                        <div class="card d-flex flex-column" style="border: 1px solid #ddd; box-shadow: none; width: 100%; max-width: 250px;">
                          ...
                          <div class="card-body p-2 d-flex flex-column">
                            ...
                            <div class="d-flex flex-column gap-1 text-nowrap mt-auto">
                              ...
                              <button type="button" class="btn btn-label-primary d-flex align-items-center btn-inscripcion" data-event-id="5" user-type="usuario" post-type="publi" style="font-size: 0.75rem;">
                                <span>Inscripción</span><i class="bx bx-chevron-right lh-1 scaleX-n1-rtl"></i>
                              </button>
                            </div>
                          </div>
                        ...
                        <div class="card d-flex flex-column" style="border: 1px solid #ddd; box-shadow: none; width: 100%; max-width: 250px;">
                          ...
                          <div class="card-body p-2 d-flex flex-column">
                            ...
                            <div class="d-flex flex-column gap-1 text-nowrap mt-auto">
                              ...
                              <button type="button" class="btn btn-label-primary d-flex align-items-center btn-inscripcion" data-event-id="6" user-type="usuario" post-type="publi" style="font-size: 0.75rem;">
                                <span>Inscripción</span><i class="bx bx-chevron-right lh-1 scaleX-n1-rtl"></i>
                              </button>
                            </div>
                          </div>
        ...
        <footer class="footer">
          <div class="container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-3">
            ...
            <div>
              ...
              <a href="javascript:void(0)" class="footer-link text-muted">Términos &amp; Condiciones</a>
            </div>
          </div>
        </footer>
      </div>
