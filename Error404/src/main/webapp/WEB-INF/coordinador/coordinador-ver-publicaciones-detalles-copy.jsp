            ...
            <span class="app-brand-logo demo">
              <img class = "h-px-50 tf-icon" src="../../assets/img/logo_Alianza_Animal_-removebg-preview.png" alt="logo">
                ...
                <span class="d-inline-block justify-content-center">
                  <span class="text-muted fw-light">Publicacion /</span> Detalles
              </span>
                                </div>
                            </div>
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <div class="row">
                                    ...
                                    <div class="card g-3 mt-4">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center flex-wrap mb-2 gap-1">
                                                <div class="me-1">
                                                    <h3 class="mb-2 text-black">¡Dale una oportunidad a Claudio!</h3>
                                                </div>
                                            ...
                                            <div class="card academy-content shadow-none border">
                                                <div class="p-2 mx-auto" style="max-width: 60%;">
                                                    <div class="cursor-pointer">
                                                        <img class="img-fluid mb-3" src="../../assets/img/img7.jpg" class="w-100" alt="donacion">
                                                    </div>
                                                </div>
                                            </div>
                                            <h4 class="text-primary mt-4">Caracteristicas de la mascota:</h4>
                                            <p class="mb-4 text-dark">
                                                <strong>Nombre:</strong> Claudio<br> <strong>Raza:</strong> Labrador<br> <strong>Edad:</strong> 2 años 3 meses
                                            </p>
                                            <p class="mb-4 text-dark">
                                                Claudio es un Labrador Retriever encantador con un corazón tan grande como su tamaño. Este perrito amigable y lleno de energía está buscando un hogar que le ofrezca amor y atención. Con su pelaje brillante y su actitud juguetona, Claudio es el compañero perfecto para cualquier familia que busque un amigo leal y cariñoso.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="card g-3 mt-4">
                                        <div class="card-body">
                                            <h5 class="mb-3">¿Cómo adoptarlo?</h5>
                                            <p>Si estás interesado en adoptar a Claudio o deseas obtener más información sobre él, no dudes en ponerte en contacto con nosotros:</p>
                                            <p><strong><i class='bx bxs-user'></i> Contacto:</strong> Albergue Caritas</p>
                                            <p><strong><i class='bx bxs-phone'></i> Teléfono:</strong> <a href="tel:5555678">555-5678</a></p>
                                            <p><strong><i class='bx bx-envelope'></i> Correo:</strong> <a href="mailto:caritas.perez@email.com">juan.perez@email.com</a></p>
                                    ...
                                    <div class="card g-3 mt-4">
                                        <div class="card-body">
                                            <h5 class="mb-3">Detalles de Claudio</h5>
                                            <p><strong>Peso:</strong> 25 kg</p>
                                            <p><strong>Vacunas al día:</strong> Tiene todas sus vacunas al día, incluyendo la antirrábica y la desparasitación.</p>
                                            <p><strong>Esterilizado:</strong> Está esterilizado.</p>
                                            <p><strong>Condiciones de salud:</strong> Excelente estado de salud.</p>
                                            <p><strong>Comportamiento:</strong> Es un perro muy tranquilo y sociable. </p>
                                        </div>
                                    </div>
