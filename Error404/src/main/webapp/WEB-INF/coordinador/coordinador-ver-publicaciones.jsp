                                            ...
                                            <div class="row w-100">
                                                ...
                                                <div class="col-md-3 d-flex flex-column align-items-center btn-group p-2">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <li><a class="dropdown-item" href="coordinador-tablas-gestion.html">Todas</a></li>
                                                        <li><a class="dropdown-item" href="coordinador-tables-hogaresTemporales.html">Hogares Temporales</a></li>
                                                        <li><a class="dropdown-item" href="coordinador-tablas-publicaciones.html">Mascotas Perdidas</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="card d-flex flex-column">
                                                        ...
                                                        <div class="card-body p-2 d-flex flex-column">
                                                            ...
                                                            <div class="d-flex flex-column gap-1 text-nowrap mt-auto mb-auto">
                                                                <a class="btn btn-label-info d-flex align-items-center" style="font-size: 0.75rem;" href="coordinador-ver-publicaciones-detalles-copy.html">
