            ...
            <span class="app-brand-logo demo">
              <img class = "h-px-50 tf-icon" src="../../assets/img/logo_Alianza_Animal_-removebg-preview.png" alt="logo">
                ...
                <span class="d-inline-block justify-content-center">
                  <span class="text-muted fw-light">Solicitudes /</span> Mascota perdida
              </span>
                                </div>
                            </div>
                                    ...
                                    <div class="card g-3 mt-4">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center flex-wrap mb-2 gap-1">
                                                <div class="me-1">
                                                    <h3 class="mb-2 text-black mt-1">¡Ayuda a encontrar a mi mascota!</h3>
                                                </div>
                                                <div class="d-flex align-items-center">
                                                    <span class="badge bg-label-info">Perdido</span>
                                                    <i class='bx bx-share-alt bx-sm mx-4 cursor-pointer'></i>
                                                    <i class='bx bx-bookmarks bx-sm cursor-pointer'></i>
                                                </div>
                                            </div>
                                            <div class="card academy-content shadow-none border">
                                                <div class="p-2 mx-auto" style="max-width: 80%;">
                                                    <div class="cursor-pointer">
                                                        <img src="https://www.animalesbog.gov.co/sites/default/files/styles/noticias_galeria/public/noticias/imagenes/WhatsApp%20Image%202020-05-28%20at%2013.31.15.jpeg?itok=KpS-rVrq" class="w-100" alt="donacion">
                                                    </div>
                                                </div>
                                            </div>
                                            <h4 class="text-primary mt-4">Detalles de la mascota perdida:</h4>
                                            <h5 class="mb-4 text-dark">¡Ayúdanos a encontrar a Firulais!</h5>
                                            <p class="mb-4 text-dark">
                                                <strong>Nombre:</strong> Firulais<br>
                                                <strong>Raza:</strong> Kalupoh<br>
                                                <strong>Última vez visto:</strong> 12/10/2023 en Jr. Los Pinos 123, Miraflores, Lima.
                                            </p>
                                            <p class="mb-4 text-dark">
                                                Firulais es un perro muy amigable y podría estar asustado. ¡Gracias por cualquier información que nos puedas proporcionar para traerlo de vuelta a casa!
                                                Firulais lleva un collar rosa con una pequeña etiqueta que contiene nuestros datos de contacto, por lo que si lo ven, por favor intenten acercarse con cuidado y verificar la etiqueta.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="card g-3 mt-4">
                                        <div class="card-body">
                                            ...
                                            <p><strong><i class="fas fa-user"></i> Nombre:</strong> Juan Pérez</p>
                                            <p><strong><i class="fas fa-phone-alt"></i> Teléfono:</strong> <a href="tel:5555678">555-5678</a></p>
                                            <p><strong><i class="fas fa-envelope"></i> Correo Electrónico:</strong> <a href="mailto:juan.perez@email.com">juan.perez@email.com</a></p>
                                            <p><strong><i class="fas fa-map-marker-alt"></i> Dirección:</strong> Jr. Las Flores 123, Miraflores, Lima</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card g-3 mt-4">
                                        <div class="card-body">
                                            <h5>Actualizaciones del Caso:</h5>
                                            <table class="table table-bordered mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>El pasado viernes se visualizó en el parque central.</td>
                                                        <td>2/11/2023</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Última actualización: Se pudo visualizar cerca de la tienda.</td>
                                                        <td>12/12/2023</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Hemos recibido una llamada informando que fue visto en Barranco.</td>
                                                        <td>15/12/2023</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Equipos de búsqueda están revisando la zona cercana.</td>
                                                        <td>17/12/2023</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Se ha encontrado una pista en la calle Las Flores.</td>
                                                        <td>18/12/2023</td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2">
