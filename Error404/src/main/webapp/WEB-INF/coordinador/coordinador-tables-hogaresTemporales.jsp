            ...
            <span class="app-brand-logo demo">
              <img class = "h-px-50 tf-icon" src="../../assets/img/logo_Alianza_Animal_-removebg-preview.png" alt="logo">
                ...
                <span class="d-inline-block justify-content-center">
                  <span class="text-muted fw-light">Gestion /</span> Hogares temporales
              </span>
                                </div>
                            </div>
                                                ...
                                                <table class="table table-striped table-bordered" id="solicitudesTable">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                                                                    ...
                                                                    <span class="fw-medium">Manuel López</span>
                                                                </ul>
                                                            </td>
                                                            <td>Av. Las Palmeras 456, San Isidro, Lima</td> <!-- Dirección en Lima -->
                                                            <td>Bobby</td>
                                                            <td><span class="badge bg-label-warning">Pendiente</span></td>
                                                            <td>10-02-2023</td>
                                                            <td>555-1234</td> <!-- Teléfono -->
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Jr. Los Pinos 123, Miraflores, Lima</td> <!-- Dirección en Lima -->
                                                            <td>Firulais</td>
                                                            <td><span class="badge bg-label-success">Aprobada</span></td>
                                                            <td>09-30-2023</td>
                                                            <td>555-5678</td> <!-- Teléfono -->
                                                            <td>
                                                                <div class="d-flex gap-2">
                                                                    <!-- Botón Ver Detalles -->
                                                                    <a href="coordinador-ver-solicitud-aceptado.html" class="btn btn-label-info">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                                                                    ...
                                                                    <span class="fw-medium">Carlos Gómez</span>
                                                                </ul>
                                                            </td>
                                                            <td>Av. El Sol 789, Barranco, Lima</td> <!-- Dirección en Lima -->
                                                            <td>Max</td>
                                                            <td><span class="badge bg-label-danger">Rechazada</span></td>
                                                            <td>10-05-2023</td>
                                                            <td>555-9876</td> <!-- Teléfono -->
                                                            <td>
                                                                <div class="d-flex gap-2">
                                                                    <!-- Botón Ver Detalles -->
                                                                    <a href="coordinador-ver-solicitud-aceptado.html" class="btn btn-label-info">
