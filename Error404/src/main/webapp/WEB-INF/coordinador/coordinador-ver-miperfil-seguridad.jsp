...
<html lang="en" class="light-style layout-compact " dir="ltr" data-theme="theme-semi-dark" data-assets-path="../../assets/" data-template="vertical-menu-template-semi-dark">
    ...
    <head>
        ...
        <link rel="stylesheet" href="..css/rtl/theme-semi-dark.css" class="template-customizer-theme-css" />
            ...
            <span class="app-brand-logo demo">
              <img class = "h-px-50 tf-icon" src="../../assets/img/logo_Alianza_Animal_-removebg-preview.png" alt="logo">
                ...
                <span class="d-inline-block justify-content-center">
                  <span class="text-muted fw-light">Usuario /</span> Seguridad
              </span>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="info-container">
                                                ...
                                                <div class="d-flex justify-content-center pt-3">
                                                    <a href="coordinador-editar-perfil.html" class="btn btn-warning"><i class='bx bx-edit'></i>Editar</a>
                                                </div>
                                ...
                                <div class="col-xl-8 col-lg-7 col-md-7 order-1 order-md-1">
                                    ...
                                    <ul class="nav nav-pills flex-column flex-md-row mb-3">
                                        <li class="nav-item"><a class="nav-link" href="coordinador-miperfil-detalles.html"><i class="bx bx-user me-1"></i>Cuenta</a></li>
