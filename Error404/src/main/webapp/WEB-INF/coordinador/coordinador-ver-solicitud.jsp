                                    ...
                                    <div class="card g-3 mt-4">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center flex-wrap mb-2 gap-1">
                                                <div class="me-1">
                                                    <h3 class="mb-2 text-black mt-1">¡Ayuda a encontrar a Maya!</h3>
                                                </div>
                                            ...
                                            <p class="mb-4 text-dark">
                                                <strong>Nombre:</strong> Maya<br>
                                                <strong>Raza:</strong> Kalupoh<br>
                                                <strong>Última vez visto:</strong> 12/10/2023 en Jr. Los Pinos 123, Miraflores, Lima.
                                            </p>
                                            <p class="mb-4 text-dark">
                                                Maya es un perro muy amigable y podría estar asustado. ¡Gracias por cualquier información que nos puedas proporcionar para traerlo de vuelta a casa!
                                                Maya lleva un collar rosa con una pequeña etiqueta que contiene nuestros datos de contacto, por lo que si lo ven, por favor intenten acercarse con cuidado y verificar la etiqueta.
                                            </p>
                                        </div>
                                    </div>
                                </div>
