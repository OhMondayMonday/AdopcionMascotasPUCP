          ...
          <span class="app-brand-logo demo">
            <img class = "h-px-50 tf-icon" src="../../assets/img/logo_Alianza_Animal_-removebg-preview.png" alt="logo">
              ...
              <span class="d-inline-block justify-content-center">
                <span class="text-muted fw-light"></span> Gestion
            </span>
                                </div>
                            </div>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                                                                    ...
                                                                    <span class="fw-medium">Julia Minaya </span>
                                                                </ul>
                                                            </td>
                                                            <td>Publicación</td>
                                                            <td>Mascota perdida: Luna, perrita criolla, color: tricolor</td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                                                                    ...
                                                                    </li> <span class="fw-medium">Gonzalo Alvizuri</span>
                                                                </ul>
                                                            </td>
                                                            <td>Hogar Temporal</td>
                                                            <td>Solicito hogar temporal para Firulais. </td>
                                                            <td>
                                                                <span class="badge bg-label-success">Aprobada</span>
                                                        ...
                                                        <tr>
                                                            <td><ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                                                                ...
                                                                </li> <span class="fw-medium">Brenda Roldan</span>
                                                            </ul>
                                                            </td>
                                                            <td>Publicación</td>
                                                            <td>Mascota perdida: Max, Chihuahua, color marrón</td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Publicación</td>
                                                            <td>Mascota perdida: Oliver, Gato, color gris con rayas</td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td><ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                                                                ...
                                                                </li> <span class="fw-medium">Manuel Aliaga</span>
                                                            </ul>
                                                            </td>
                                                            <td>Hogar Temporal</td>
                                                            <td>Solicito hogar temporal para Toby, perrito de 3 años.</td>
                                                            <td>
