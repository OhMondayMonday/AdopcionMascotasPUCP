...
<html lang="en" class="light-style layout-navbar-fixed layout-menu-fixed layout-compact " dir="ltr" data-theme="theme-semi-dark" data-assets-path="../../assets/" data-template="vertical-menu-template-semi-dark">
    ...
    <head>
        ...
        <title>Solicitudes Hogares Temporales</title>
                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            ...
                            <h4 class="py-3 mb-4">
                                <span class="text-muted fw-light"></span> Peticiones para Hogar Temporal
                            </h4>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6 d-flex align-items-center">
                                            <h5 class="card-title mb-0">Registro de Peticiones</h5>
                                        </div>
