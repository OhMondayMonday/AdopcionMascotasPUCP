              ...
              <div class="card border-0 mb-4 p-3">
                <div class="card-body row p-0 pb-3">
                  <div class="col-12 col-md-8 card-separator">
                    <h3 class="text-dark">¡Bienvenido, Albergue Huellas! 👋🏻 </h3>
          ...
          <span class=" bg-label-primary p-2 rounded">
            <i class='bx bx-laptop bx-sm'></i>
                        ...
                        <div class="content-right">
                          ...
                          <h4 class="text-primary mb-0">119</h4>
                        </div>
                      </div>
                ...
                <div class="col-sm-12 col-xl-4 col-md-6">
                  <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h5 class="card-title m-0 me-2">Albergue Huellas</h5>
                    </div>
                    <div class="card-body row g-3">
                      <div class="col-md-12">
                        <img class = "img-fluid h-100" src="../../assets/img/huella.jpg" alt = "fotoperfil">
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-12 col-xl-4 col-md-6">
                  <div class="card h-100">
                    <div class="card-body">
                      ...
                      <h4 class="mb-2 pb-1">Proximo evento</h4>
                      <p class="small">Sigue compartiendo con los demas por un bien animal</p>
                      <div class="row mb-3 g-3">
                        <div class="col-6">
                          <div class="d-flex">
                            ...
                            <div>
                              <h6 class="mb-0 text-nowrap">10-09-2024</h6>
                        ...
                        <div class="col-6">
                          <div class="d-flex">
                            ...
                            <div>
                              <h6 class="mb-0 text-nowrap">Plaza San Miguel</h6>
                              <small>Lugar</small>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="row mb-1 align-items-center justify-content-center">
                        <small>Deseas crear una nueva publicacion?</small>
                      </div>
                      <a href="crear-publicacion-usuariofinal-normal.html" class="btn btn-facebook w-100">Nueva publicacion</a>
                    </div>
                  </div>
                </div>

                <div class="col-xl-4 col-lg-4 col-md-12 col-12 order-md-2">
                  <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <div class="card-body">
                      ...
                      <ul class="timeline">
                        <li class="timeline-item timeline-item-transparent">
                          ...
                          <div class="timeline-event">
                            <div class="timeline-header mb-1">
                              <h6 class="mb-0">Albergue Huellas realizo una actualizacion</h6>
                        ...
                        <li class="timeline-item timeline-item-transparent">
                          ...
                          <div class="timeline-event">
                            <div class="timeline-header mb-1">
                              <h6 class="mb-0">Se realizo una solicitud a Luis Pozo</h6>
                              <small class="text-muted">Hace 4 min</small>
                            </div>
                            ...
                            <div class="d-flex flex-wrap">
                              ...
                              <div>
                                <h6 class="mb-0">Solicitud a Luis Pozo</h6>
                                <span>Se realizo la solicitud para hogar temporal</span>
                              </div>
                            </div>
                          </div>
                        </li>
