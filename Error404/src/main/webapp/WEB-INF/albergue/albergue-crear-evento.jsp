    ...
    <div class="layout-container">
        ...
        <div class="layout-page">
            <nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme" id="layout-navbar">
                ...
                <p class="mb-0 fst-normal fw-semibold ff-">Crear Evento </p>
              </span>
                        </div>
                    </div>
                        ...
                        <div class="col-12 mb-2">
                            <div class="bs-stepper wizard-numbered mt-2">
                                ...
                                <div class="bs-stepper-content">
                                    ...
                                    <form action="EventosServlet?action=crearEvento" method="POST">
                                        <!-- Detalles Evento -->
                                        <div id="datos-evento" class="content">
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" class="form-control" id="fechaEvento" name="fechaEvento" placeholder="AAAA-MM-DD">
                                                </div>

                                                <div class="col-sm-6">
                                                    <label class="form-label" for="direccionLugar">Dirección del lugar</label>
                                                    <input type="text" class="form-control" id="direccionLugar" required name="direccionLugar" placeholder="Dirección del lugar">
                                                </div>
                                                <div class="col-sm-6">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <textarea class="form-control" id="descripcionEvento" name="descripcionEvento" rows="8" required placeholder="Ingrese una descripción detallada del evento"></textarea>
                                                </div>
                                        ...
                                        <div id="datos-albergue" class="content">
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="number" required class="form-control" id="aforo" placeholder="Indique el Aforo" name="aforo">
                                                </div>
                                                <div class="col-sm-6">
                                                    <label class="form-label" for="entrada">Entrada</label>
                                                    <input type="text" class="form-control" id="entrada" name="entrada" placeholder="Indique costo o requerimiento de la entrada">
                                                </div>
                                                <div class="col-sm-6">
                                                    <label class="form-label" for="artistasProveedores">Artistas Invitados</label>
                                                    <input type="text" class="form-control" id="artistasProveedores" name="artistasProveedores" placeholder="Indique algún Artista Invitado">
                                                </div>
                                                <div class="col-12">
                                                    <label class="form-label" for="razonEvento">Razón</label>
                                                    <input type="text" class="form-control" id="razonEvento" placeholder="Indique la Razón del Evento" name="razonEvento">
                                                </div>
                                                ...
                                                <div class="col-12 d-flex justify-content-between">
                                                    ...
                                                    <button type="submit" class="btn btn-success btn-submit">Publicar</button>
                                                </div>
