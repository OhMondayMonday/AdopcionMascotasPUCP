                                ...
                                <div class="card-body row g-3">
                                    <div class="col-lg-8">
                                        <div class="d-flex justify-content-between align-items-center flex-wrap mb-2 gap-1">
                                            <div class="me-1">
                                                <h3 class="mb-3 mt-2 text-black">Refugio de Laura</h3>
                                            </div>
                                            <div class="d-flex align-items-center">
                                                <span class="badge bg-label-info">Donación</span>
                                        ...
                                        <div class="card academy-content shadow-none border">
                                            <div class="p-2 mx-auto">
                                                <div class="cursor-pointer">
                                                    <img src="../../assets/img/1.jpg" class="h-auto w-px-500"  alt="donacion">
                                                </div>
                                            </div>
                                            <!--
                                            <div class="card-body">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <h4 class="text-primary" style="margin-top: 45px;">Descripción</h4>
                                        <p class="mb-4 text-dark">
                                            Después de un arduo esfuerzo de recolección y con el apoyo de muchas personas generosas, estamos a tan
                                            solo 100 soles de alcanzar nuestro objetivo. Este logro nos acerca cada vez más a hacer realidad nuestro
                                            proyecto, que traerá beneficios significativos a quienes más lo necesitan.
                                        </p>
                                        <p class="mb-4 text-dark">
                                            Cada aporte cuenta, y con tu ayuda, podremos llegar a la meta final. ¡Gracias por ser parte de esta causa
                                            tan especial!
                                        </p>
