                                                    ...
                                                    <div class="card d-flex flex-column" style="border: 1px solid #ddd; box-shadow: none; width: 100%; max-width: 250px;">
                                                        ...
                                                        <div class="card-body p-2 d-flex flex-column">
                                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                                <span class="badge bg-label-info" style="font-size: 0.75rem;">Adopcion</span>
                                                            </div>
                                                            <a class="h6" href="albergue-editar-publicacion-adopcion.html" style="font-size: 0.875rem;">¡Dale una oportunidad a Claudio!</a>
                                                            ...
                                                            <div class="d-flex flex-column gap-1 text-nowrap mt-auto mb-auto">
                                                                <a class="btn btn-label-primary d-flex align-items-center" style="font-size: 0.75rem;" href="albergue-editar-publicacion-adopcion.html">
                                                ...
                                                <div class="col-12 col-sm-6 col-md-4 col-lg-2 px-1 mb-2 d-flex justify-content-center">
                                                    <div class="card d-flex flex-column" style="border: 1px solid #ddd; box-shadow: none; width: 100%; max-width: 250px;">
                                                        ...
                                                        <div class="card-body p-2 d-flex flex-column">
                                                            ...
                                                            <a class="h6" href="albergue-editar-publicacion-adopcion.html" style="font-size: 0.875rem;">¿Buscas un compañero fiel?</a>
                                                ...
                                                <div class="col-12 col-sm-6 col-md-4 col-lg-2 px-1 mb-2 d-flex justify-content-center">
                                                    <div class="card d-flex flex-column" style="border: 1px solid #ddd; box-shadow: none; width: 100%; max-width: 250px;">
                                                        ...
                                                        <div class="card-body p-2 d-flex flex-column">
                                                            ...
                                                            <a class="h6" href="albergue-editar-publicacion-donacion.html" style="font-size: 0.875rem;">¡Cada dólar cuenta!</a>
                                                            <p class="mt-1 mb-0" style="font-size: 0.75rem;">Bobby fue operado la semana pasada y necesita otra operación de apéndice</p>
                                                            <div class="d-flex flex-column gap-1 text-nowrap mt-auto mb-auto">
                                                                <a class="btn btn-label-primary d-flex align-items-center" style="font-size: 0.75rem;" href="albergue-editar-publicacion-donacion.html">
                                                                    <span>Editar</span><i class="bx bx-chevron-right lh-1 scaleX-n1-rtl"></i>
                                                                </a>
                                                                <a class="btn btn-label-secondary d-flex align-items-center" href="#" style="font-size: 0.75rem;">
                                                                    <span>Borrar </span><i class="bx bx-sync align-middle me-1"></i>
                                                ...
                                                <div class="col-12 col-sm-6 col-md-4 col-lg-2 px-1 mb-2 d-flex justify-content-center">
                                                    <div class="card d-flex flex-column" style="border: 1px solid #ddd; box-shadow: none; width: 100%; max-width: 250px;">
                                                        ...
                                                        <div class="card-body p-2 d-flex flex-column">
                                                            ...
                                                            <a class="h6" href="albergue-editar-publicacion-donacion.html" style="font-size: 0.875rem;">Ayúdanos a llegar al objetivo</a>
                                                            <p class="mt-1 mb-0" style="font-size: 0.75rem;">Bobby fue operado la semana pasada y necesita otra operación de apéndice</p>
                                                            <div class="d-flex flex-column gap-1 text-nowrap mt-auto mb-auto">
                                                                <a class="btn btn-label-primary d-flex align-items-center" style="font-size: 0.75rem;" href="albergue-editar-publicacion-donacion.html">
                                                                    <span>Editar</span><i class="bx bx-chevron-right lh-1 scaleX-n1-rtl"></i>
                                                ...
                                                <div class="col-12 col-sm-6 col-md-4 col-lg-2 px-1 mb-2 d-flex justify-content-center">
                                                    <div class="card d-flex flex-column" style="border: 1px solid #ddd; box-shadow: none; width: 100%; max-width: 250px;">
                                                        ...
                                                        <div class="card-body p-2 d-flex flex-column">
                                                            ...
                                                            <a class="h6" href="albergue-editar-publicacion-donacion.html" style="font-size: 0.875rem;">¡Vamos por la meta!</a>
                                                            <p class="mt-1 mb-0" style="font-size: 0.75rem;">Bobby fue operado la semana pasada y necesita otra operación de apéndice</p>
                                                            <div class="d-flex flex-column gap-1 text-nowrap mt-auto mb-auto">
                                                                <a class="btn btn-label-primary d-flex align-items-center" style="font-size: 0.75rem;" href="albergue-editar-publicacion-donacion.html">
                                                                    <span>Editar</span><i class="bx bx-chevron-right lh-1 scaleX-n1-rtl"></i>
                                                ...
                                                <div class="col-12 col-sm-6 col-md-4 col-lg-2 px-1 mb-2 d-flex justify-content-center">
                                                    <div class="card d-flex flex-column" style="border: 1px solid #ddd; box-shadow: none; width: 100%; max-width: 250px;">
                                                        ...
                                                        <div class="card-body p-2 d-flex flex-column">
                                                            ...
                                                            <a class="h6" href="albergue-editar-publicacion-donacion.html" style="font-size: 0.875rem;">¡Únete a la causa!</a>
                                                            <p class="mt-1 mb-0" style="font-size: 0.75rem;">Bobby fue operado la semana pasada y necesita otra operación de apéndice</p>
                                                            <div class="d-flex flex-column gap-1 text-nowrap mt-auto mb-auto">
                                                                <a class="btn btn-label-primary d-flex align-items-center" style="font-size: 0.75rem;" href="albergue-editar-publicacion-donacion.html">
                                                                    <span>Editar</span><i class="bx bx-chevron-right lh-1 scaleX-n1-rtl"></i>
