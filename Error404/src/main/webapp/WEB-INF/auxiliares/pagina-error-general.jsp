...
<head>
    ...
    <title>Alianza Animal || Error</title>
...
<div class="container-xxl container-p-y">
    <div class="misc-wrapper">
        <h2 class="mb-2 mx-2">Se ha producido un error inesperado :(</h2>
        <p class="mb-4 mx-2">¡Ups! 😖😭 Tendremos que arreglar esto pronto. Los queremos mucho</p>
