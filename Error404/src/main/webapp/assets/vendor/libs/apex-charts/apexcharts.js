                ...
                var b = function () {
                    ...
                    return h(t, [{
                        ...
                        key: "escapeString", value: function (t) {
                            ...
                            return t.toString().slice().replace(/[` ~!@#$%^&*()_|+\-=?;:'",.<>{}[\]\\/]/gi, e)
                        }
                    }, {
                    ...
                    return h(t, [{
                        ...
                        key: "drawDataLabel", value: function (t, e, i) {
                            ...
                            for (var g = 0; g < t.x.length; g++) if (l = t.x[g] + n.offsetX, h = t.y[g] + n.offsetY + s, !isNaN(l)) {
                                ...
                                "bubble" === r.config.chart.type ? (p = f(u = r.globals.seriesZ[e][c]), h = t.y[g], h = new z(this.ctx).centerTextInBubble(h, e, c).y) : void 0 !== u && (p = f(u)), this.plotDataLabelsText({
                                    x: l,
                                    y: h,
                                    text: p,
                                    i: e,
                    ...
                    return h(t, [{
                        ...
                        key: "moveXAxisTooltip", value: function (t) {
                            ...
                            if (null !== i.xaxisTooltip) {
                                ...
                                t -= i.xaxisTooltip.getBoundingClientRect().width / 2, isNaN(t) || (t += e.globals.translateX, a = new y(this.ctx).getTextRects(i.xaxisTooltipText.innerHTML), i.xaxisTooltipText.style.minWidth = a.width + "px", i.xaxisTooltip.style.left = t + "px", i.xaxisTooltip.style.top = s + "px")
                            }
                        }
                    }, {
