...
$(function () {
    ...
    n.length && (t = n.DataTable({
        ...
        columnDefs: [{
            ...
            targets: 2, responsivePriority: 1, render: function (t, e, s, a) {
                var n = s.product_name, o = s.id, c = s.product_brand, i = s.image;
            ...
            targets: 3, responsivePriority: 5, render: function (t, e, s, a) {
            ...
            targets: 4, orderable: !1, responsivePriority: 3, render: function (t, e, s, a) {
                s = s.stock;
            ...
            targets: 5, render: function (t, e, s, a) {
                return "<span>" + s.sku + "</span>"
            }
        }, {
            targets: 6, render: function (t, e, s, a) {
                return "<span>" + s.price + "</span>"
            }
        }, {
            targets: 7, responsivePriority: 4, render: function (t, e, s, a) {
                return "<span>" + s.qty + "</span>"
            }
        }, {
            targets: -2, render: function (t, e, s, a) {
                s = s.status;
                return '<span class="badge ' + o[s].class + '" text-capitalized>' + o[s].title + "</span>"
            }
        }, {
            targets: -1, title: "Actions", searchable: !1, orderable: !1, render: function (t, e, s, a) {
        ...
        responsive: {
            details: {
                ...
                }), type: "column", renderer: function (t, e, s) {
